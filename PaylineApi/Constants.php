...
class Constants
{
    ...
    // @see : https://docs.payline.com/display/DT/Codes+-+Action
    ...
    // @see https://docs.payline.com/pages/viewpage.action?pageId=747146980
    ...
    //Constante Cycling payment NX / REC
    const PAYMENT_BACK_CODES_RETURN_CYCLING_SUCCESS = ['1'];
    const PAYMENT_BACK_CODES_RETURN_CYCLING_ERROR = ['2'];
